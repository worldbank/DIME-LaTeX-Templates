...
\begin{enumerate}
	...
	\item Now if you compare the pdf file you have just generated with you new data with the one you saved in a differnt folder in the beginning of this section, you will find that the tables have updated automatically without you having to do any manual edits. 
\end{enumerate}
