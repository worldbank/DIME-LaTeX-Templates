...
\section*{Part 6: Making a Dynamic Document \\ Using a do-file to edit a .tex file after exporting it}
...
Here, we will produce a dynamic document. Please only do this do if you have completed up to the last Part of the exercise. 

\begin{enumerate}
	\item Go to \texttt{line 60} of the Stata do file and change the seed from \texttt{215320} to a number different than \texttt{215320}. 
