...
%Mirjan: Hightlight the difference between these two tasks in part 5. We are not making it easy for the user to match the main popint of having these two differences.
...
%Mrijan: Elaboreate. Say that this can be used for any graph produced here. Talk about how twoway stores in temporary memory and export saves to disk. These are teh details not obvious to a user with no assumed previous knowledge.
