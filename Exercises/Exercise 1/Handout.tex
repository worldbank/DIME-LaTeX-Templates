...
\textbf{Task 3:} Now we want to make sure that the figure is centerd on the page in our document. Center your figure by adding the line in blue:
\begin{center}
	\begin{Verbatim}[commandchars=+\(\)]
	\begin{figure}[H]
...
\section*{Part 6. Update {\LaTeX} file after making changes to the data}
