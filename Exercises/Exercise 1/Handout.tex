...
\section*{Part 6. Centering imported objects}
...
Compile your document. The titles shown in these lists are those defined by \verb|\caption|. Go to any of your figures or tables and change the caption and compile the document again. See how the list of tables and figures is updated. While it is common practice, you do not need to add \verb|\maketitle| and \verb|\listoftables| in the beginning of the document. You can add them anywhere.
