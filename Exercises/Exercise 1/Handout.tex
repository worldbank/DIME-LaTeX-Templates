...
\begin{document}
	...
	\textcolor{orange}{\textbf{Task 1:}} Below the code that was generated when you imported the first figure (but before \verb|\end{document}|), create a figure environment and import \emph{iegraph.png} into it. You will find that graph in the \emph{Raw} folder. You import that figure by typing the following lines of code:
	...
	\textcolor{orange}{\textbf{Task 2:}} We need to adjust the size of your figure so it fits into the page. Use the \verb|\width| option of \verb|\includegraphics{}| to do this by typing the context in blue:
	...
	\textcolor{orange}{\textbf{Task 3:}} Add a title to your figure using the \verb|\caption| command:
	...
	\textcolor{orange}{\textbf{Task 3:}} Similar to figures, you can add a caption to your table. This is done by adding the same lines as for figures. Note that the caption needs to be outside of the \texttt{adjustbox} environment.
	...
	Until now, we imported object into our document that were too wide for our document's margins, so we had to adjust their sizes. Next, we are going to see what happens when we import a narrower object. To do this, create a new table environment (\verb|\begin{table}| and \verb|\end{table}|) in the document you have been working in, import and create a title for the table in \emph{sampl\_sizes.tex}. This can be done by typing the following lines:
